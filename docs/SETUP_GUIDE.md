...
-   Shortcodes available in page/post content: `[post slug="<slug>" display="full|medium|small|link"]`, `[page slug="<slug>" display="link"]`, `[media id="<id>" width="<css>"]`
...
```
JWT_SECRET=your-secret-key-change-in-productionPORT=3001NODE_ENV=development
```
